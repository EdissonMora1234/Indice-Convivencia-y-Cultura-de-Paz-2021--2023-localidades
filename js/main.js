document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_de_Convivencia_y_Cultura_de_Paz_2021', displayName: 'Subindice_Convivencia_y_Cultura_de_Paz_2021' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_de_Convivencia_y_Cultura_de_Paz_2023', displayName: 'Subindice_Convivencia_y_Cultura_de_Paz_2023' }
    ];
